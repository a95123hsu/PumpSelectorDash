...
def render_main_content(pumps_data, curve_data):
    """Render main content - always show UI, with loading states for data-dependent parts"""
    # Always show the main UI structure
    loading_msg = not pumps_data
    # Always show the main UI structure
    loading_msg = not pumps_data
    ...
    return html.Div([
        ...
        html.Div([
            ...
            html.Div(className='sidebar', children=[
                # Loading overlay for sidebar when no data
                html.Div([
                    html.Div(
                        className='modern-card',
                        style={'textAlign': 'center', 'padding': '40px', 'position': 'relative'},
                        children=[
                            html.I(className="fas fa-spinner fa-spin", style={'fontSize': '32px', 'color': '#0066CC', 'marginBottom': '16px'}),
                            html.H4("Loading Controls...", style={'color': '#2c3e50', 'margin': '0'}),
                        ]
                    )
                ] if loading_msg else []),
                
                # Actual controls - shown when data is available
                html.Div([
                ...
                ], style={'display': 'none' if loading_msg else 'block'}),
            ...
            html.Div(className='content-area', children=[
                ...
                # Actual content - shown when data is available
                html.Div([
                    # Results section
